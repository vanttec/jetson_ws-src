...
class Detection_Node:
    def __init__(self):
        ...
        self.image = cv2.imread("/home/fitocuan/vantec-config/p1.jpg")
        ...
        while not rospy.is_shutdown():
            ...
            for ix in indices:
			    ...
			    if detect == True:
				    ...
				    dist = self.points_list[(p1+p2*1280)][0]
				    ...
				    obj.h = h
				    obj.w = w
				    obj.X = self.points_list[(p1+p2*1280)][0]
				    obj.Y = self.points_list[(p1+p2*1280)][1]
				    obj.color = color
